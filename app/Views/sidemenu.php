<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top d-flex align-items-center bg-primary fixed-top">

    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard.php" class="logo d-flex align-items-center">
        <img src="<?= base_url(''); ?>/assets/img/mhs.png" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?= base_url(''); ?>/assets/img/imagepp3.jpg" alt="Profile" class="rounded-circle">
  ...
  <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar bg-primary fixed-top">
